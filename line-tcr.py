...
cl = LINETCR.LINE() 
cl.login(token="ElEljbCQmXIC0nJgiCB0.2PshkH9jZu06gbOeQKJtua.BuhTfL0MvYaH+MCfM9SWzrPIFflirepU3J4lJk/op9A=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                    ...
                    kc.sendText(msg.to, "Tuan Rashif sendirian nih")
                    try:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        kc.sendText(msg.to,"Tuanku Rashif")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
...
#-----------------------------------------------------------------
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Owner:Rashif :) yang tampan dan rupawan")
