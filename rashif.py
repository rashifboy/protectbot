...
cl = TOBY.LINE()
cl.login(token="EmNSYtVy9cUJ9ZrXp2F0.2PshkH9jZu06gbOeQKJtua./zNEjH35G1pfpQEpwFCpiYf8bViwlnvdWarJyIxERSI=")
cl.loginResult

ki = TOBY.LINE()
ki.login(token="EmuhnYPxW5dDQqUkEPp5.PtU14xG9qDZsMoFG8SHeXq.RQ5ZFfzkFEZcGF99pR8zOVDrhKPX67Yc4eODYZlBHfM=")
ki.loginResult
...
Bots=[mid,Amid,"ue2101fb9b105a2341d4d511635a12353"]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Terimakasih telah menambahkan saya sebagai teman my own : line://ti/p/~rsf.22",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~rsf.22",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
